...
%%{init: {'theme':'dark'}}%%
graph TD
    A[Users / Analysts] --> B[API Gateway]
    ...
    G --> H[Pinecone / FAISS / Chroma]
    H --> I[Enterprise Data]

    I --> J[Compliance Docs]
    I --> K[Financial Transactions]
    I --> L[Risk Signals]
```
...
%%{init: {'theme':'dark'}}%%
graph TD
    A[Passenger App] --> B[tRPC API Layer]
    C[Driver App] --> B
    B --> D[Ride Matching Engine]
    B --> E[Auth Service]
    B --> F[Payment Service]

    D --> G[PostgreSQL]
    D --> H[Redis Real-Time Layer]
    D --> I[Google Maps APIs]
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0066FF,45:001B44,100:000000&height=120&section=footer" />
